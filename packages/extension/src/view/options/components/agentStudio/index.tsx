...
export default function AgentDashboard() {
  ...
  const handleSaveAgent = useCallback((data: AgentType) => {
    if (data.id) {
      // Update existing
  ...
  return (
    <OptionsPageTab title="Agent Studio" description='Manage your LLM agents, configure connection settings, and fine-tune inference parameters.'>
      {/* Modal */}
      <ConfigModal
        isOpen={isModalOpen}
            ...
            >
              ...
              <div className="flex items-center gap-4 py-3 border-t border-darth-vader border-dashed">
                <div className="flex flex-col">
                  <span className="text-[10px] text-exclusive-plum uppercase font-semibold">Temp</span>
