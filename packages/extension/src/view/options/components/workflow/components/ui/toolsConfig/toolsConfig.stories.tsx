...
const meta: Meta<typeof ToolsConfig> = {
	...
	argTypes: {
		onLabelChange: {
			description:
				'Callback function when the label of the tool changes.',
			action: 'label changed',
		},
		onContextChange: {
			description:
				'Callback function when the context of the tool changes.',
			action: 'context changed',
		},
		onFormChange: {
			description:
				'Callback function when the form data of the tool changes.',
			action: 'form changed',
		},
		selectedNodeId: {
