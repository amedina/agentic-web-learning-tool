...
import type { DataTransformerConfig } from "@agentic-web-labs/engine-core";
...
const DataTransformerToolNode = () => {
  ...
  const config = useMemo(() => {
    ...
    const _config = node.config as DataTransformerConfig;
  ...
  return (
    <ToolNodeContainer
      title={config?.title || "Transformer"}
      Icon={Database}
      type={config?.type || "dataTransformer"}
...
export default DataTransformerToolNode;
