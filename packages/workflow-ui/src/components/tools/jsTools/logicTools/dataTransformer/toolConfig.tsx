  ...
  useImperativeHandle(
    ...
    () => ({
      getConfig: (formData: FormData) => {
        ...
        switch (op) {
          case "regex":
            configResult.pattern = (formData.get("pattern") as string) || "";
            configResult.flags = (formData.get("flags") as string) || "";
            break;
          case "jsonParse":
            configResult.path = (formData.get("path") as string) || "";
            break;
          case "format":
          ...
          case "join":
            ...
            if (op === "split")
              configResult.index = (formData.get("index") as string) || "0";
            break;
          case "template":
            configResult.template = (formData.get("template") as string) || "";
            break;
          case "filter":
            ...
            break;
          case "map":
            configResult.mapPath = (formData.get("mapPath") as string) || "";
            break;
        }
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setOperation(
                  e.target.value as DataTransformerConfig["operation"],
                )
              }
            ...
            >
              ...
              <option value="format">Text Formatting (Case/Trim)</option>
          ...
          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-md space-y-3">
            ...
            {(operation === "objectKeys" || operation === "objectValues") && (
