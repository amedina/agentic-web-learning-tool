...
export const ComparisonTable: React.FC<ComparisonTableProps> = ({
  ...
  <>
    <div className="overflow-x-auto max-w-full">
      <div className="w-fit">
        <div className="flex items-center justify-end my-4 pr-[4px]">
          <button
        ...
        <div className="w-fit rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
          <table className="w-fit rounded-xl bg-white dark:bg-slate-800 text-sm table-fixed">
            ...
            <tbody>
              ...
              <tr>
                <td className="px-6 py-4 font-medium text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 rounded-bl-xl">
                  License Match
                </td>
                {comparisonBucket.map((pkg, idx) => (
                  <td
                    key={idx}
                    className={`px-6 py-4 ${idx !== comparisonBucket.length - 1 ? "border-r" : ""} border-slate-200 dark:border-slate-700 ${idx === comparisonBucket.length - 1 ? "rounded-br-xl" : ""}`}
                  >
