 ...
 */
import { UserMessage, GlobalHeader, ErrorBoundary } from "./tabs";
    ...
    <ErrorBoundary>
      <ThemeProvider>
        <PropProvider
          ...
          assistantMessage={CompareAssistantMessage}
          userMessage={UserMessage}
          getCustomSystemPrompt={() =>
            getCompareSystemPrompt(JSON.stringify(comparisonBucket, null, 2))
          }
          suggestions={[
            {
...
export default ComparisonPageSidePanel;
