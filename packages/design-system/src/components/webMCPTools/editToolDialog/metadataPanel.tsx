						...
						<div className="space-y-4">
							<div>
								...
								<p className="text-[10px] text-gray-400 mt-1">
									Unique identifier for the tool (e.g.
									"search_web")
								</p>
							</div>
							<div>
								...
								<p className="text-[10px] text-gray-400 mt-1">
									Grouping identifier to escape naming
									collisions
								</p>
							</div>
							<div>
								...
								<p className="text-[10px] text-gray-400 mt-1">
									Human-readable description of what the tool
									does
								</p>
							</div>
							<div>
								...
								<div className="px-3 py-2 bg-extreme-zinc border border-gray-200 rounded font-mono text-xs text-gray-700 dark:bg-zinc-800 dark:border-zinc-700 dark:text-gray-200">
									{(() => {
										...
										return String(patterns).replace(
											/[[\]"]/g,
											''
										);
									})()}
							...
							<div>
								...
								<p className="text-[10px] text-gray-400 mt-1">
									JSON Schema defining the arguments the tool
									accepts
								</p>
							</div>
						</div>
