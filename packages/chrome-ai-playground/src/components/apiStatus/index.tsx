    ...
    >
      ...
      <div className="mt-8 pt-6 border-t border-border/50 text-xs text-muted-foreground">
        ...
        <ul className="list-disc pl-4 space-y-1">
            <li><strong>Chrome Flags:</strong> Extensions cannot directly read Chrome flag statuses. Instead, we infer their status by verifying the availability of the associated APIs.</li>
            <li><strong>Model Download:</strong> Models are downloaded on-demand. Checks determine if a model is ready to use or requires downloading.</li>
        </ul>
      </div>
    </OptionsPageTab>
  );
